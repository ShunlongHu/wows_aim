...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default= r'C:\work\wows_aim\best.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default=r'C:\work\wows_aim\SmokeScreenShots', help='file/dir/URL/glob, 0 for webcam')
