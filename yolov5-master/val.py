...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=r'C:\work\wows_aim\yolov5-master\yolo_wows\exp\weights\best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--project', default='yolo_wows', help='save to project/name')
